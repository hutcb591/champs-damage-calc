...
const ZA_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Lickilicky: {otherFormes: ['Lickilicky-Mega']},
  Lucario: {otherFormes: ['Lucario-Mega', 'Lucario-Mega-Z']},
  Luvdisc: {otherFormes: ['Luvdisc-Mega']},
  ...
  Minun: {otherFormes: ['Minun-Mega']},
  Plusle: {otherFormes: ['Plusle-Mega']},
  Pyroar: {otherFormes: ['Pyroar-Mega']},
  Raichu: {otherFormes: ['Raichu-Alola', 'Raichu-Mega-X', 'Raichu-Mega-Y']},
  Rapidash: {otherFormes: ['Rapidash-Mega', 'Rapidash-Galar', 'Rapidash-Galar-Mega']},
  Scolipede: {otherFormes: ['Scolipede-Mega']},
  Scovillain: {otherFormes: ['Scovillain-Mega']},
  Scrafty: {otherFormes: ['Scrafty-Mega']},
  Shuckle: {otherFormes: ['Shuckle-Mega']},
  'Sirfetch\u2019d': {otherFormes: ['Sirfetch\u2019d-Mega']},
  ...
  Victini: {otherFormes: ['Victini-Mega']},
  ...
  'Ariados-Mega': {
    types: ['Bug', 'Dark'],
    bs: {hp: 70, at: 120, df: 100, sa: 50, sd: 100, sp: 60},
    weightkg: 56.5,
    abilities: {0: 'Intimidate'},
    baseSpecies: 'Ariados',
  },
  ...
  'Carnivine-Mega': {		
		types: ['Grass', 'Dark'],
		bs: {hp: 74, at: 125, df: 112, sa: 105, sd: 92, sp: 46},
		weightkg: 27.0,
		abilities: {0: 'Honey Trap'},
  ...
  'Cursola-Mega': {		
		types: ['Ghost', 'Rock'],
		bs: {hp: 60, at: 100, df: 120, sa: 160, sd: 160, sp: 10},
		weightkg: 19.4,
		abilities: {0: 'Solid Rock'},
		baseSpecies: 'Cursola',
	},
  ...
  'Delibird-Mega': {
    types: ['Ice', 'Flying'],
    bs: {hp: 45, at: 120, df: 70, sa: 15, sd: 54, sp: 116},
    weightkg: 16.0,
    abilities: {0: 'Magic Guard'},
  ...
  'Dhelmise-Mega': {		
		types: ['Grass', 'Ghost'],
		bs: {hp: 70, at: 151, df: 140, sa: 86, sd: 115, sp: 55},
		weightkg: 380.0,
		abilities: {0: 'Purifying Salt'},
  ...
  'Dudunsparce-Mega': {
    types: ["Normal", "Ground"],
		bs: { hp: 125, at: 125, df: 115, sa: 95, sd: 95, sp: 65 },
    weightkg: 66.8,
    abilities: { 0: "Adaptability" },
    baseSpecies: 'Dudunsparce',
  },
  ...
  'Electrode-Mega': {		
		types: ['Electric', 'Steel'],
		bs: {hp: 60, at: 70, df: 95, sa: 110, sd: 100, sp: 155},
		weightkg: 90.8,
		abilities: {0: 'Hadron Engine'},
		baseSpecies: 'Electrode',
	},	
  ...
  'Flygon-Mega': {		
		types: ['Bug', 'Dragon'],
		bs: {hp: 80, at: 135, df: 90, sa: 120, sd: 85, sp: 110},
		weightkg: 86.4,
		abilities: {0: 'Sand Rush'},
		baseSpecies: 'Flygon',
	},
  ...
  'Heliolisk-Mega': {		
		types: ['Electric', 'Normal'],
		bs: {hp: 62, at: 70, df: 72, sa: 139, sd: 109, sp: 129},
		weightkg: 23.2,
		abilities: {0: 'Acclimated'},
		baseSpecies: 'Heliolisk',
	},
  'Lickilicky-Mega': {		
		types: ['Normal', 'Ghost'],
		bs: {hp: 110, at: 85, df: 130, sa: 105, sd: 135, sp: 50},
		weightkg: 144.4,
		abilities: {0: 'Water Absorb'},
  ...
  'Luvdisc-Mega': {		
		types: ['Water', 'Fairy'],
		bs: {hp: 43, at: 5, df: 60, sa: 105, sd: 85, sp: 132},
		weightkg: 11.9,
		abilities: {0: 'Soul-Heart'},
		baseSpecies: 'Luvdisc',
	},
  ...
  'Minun-Mega': {		
		types: ['Electric', 'Ice'],
		bs: {hp: 60, at: 40, df: 60, sa: 110, sd: 104, sp: 131},
		weightkg: 4.5,
		abilities: {0: 'Chilling Cheer'},
		baseSpecies: 'Minun',
	},
  'Plusle-Mega': {		
		types: ['Electric', 'Fire'],
		bs: {hp: 60, at: 50, df: 60, sa: 135, sd: 78, sp: 122},
		weightkg: 4.3,
		abilities: {0: 'Burning Cheer'},
		baseSpecies: 'Plusle',
	},	
  'Pyroar-Mega': {
    types: ['Fire', 'Normal'],
  ...
  'Rapidash-Mega': {		
		types: ['Fire', 'Ice'],
		bs: {hp: 65, at: 120, df: 115, sa: 80, sd: 95, sp: 125},
		weightkg: 227.4,
		abilities: {0: 'As One (Glastrier)'},
		baseSpecies: 'Rapidash',
	},
  'Rapidash-Galar-Mega': {		
		types: ['Dark', 'Fairy'],
		bs: {hp: 65, at: 100, df: 80, sa: 130, sd: 100, sp: 125},
		weightkg: 106.0,
		abilities: {0: 'As One (Spectrier)'},
  ...
  'Shuckle-Mega': {		
		types: ['Bug', 'Rock'],
		bs: {hp: 20, at: 130, df: 200, sa: 10, sd: 180, sp: 65},
		weightkg: 40.3,
		abilities: {0: 'Mold Breaker'},
		baseSpecies: 'Shuckle',
	},	
  'Sirfetch\u2019d-Mega': {		
		types: ['Fighting'],
		bs: {hp: 62, at: 175, df: 120, sa: 68, sd: 102, sp: 80},
		weightkg: 138.8,
		abilities: {0: 'Greatsword'},
  ...
  'Tropius-Mega': {		
		types: ['Grass', 'Dragon'],
		bs: {hp: 99, at: 83, df: 103, sa: 92, sd: 112, sp: 71},
		weightkg: 109.2,
		abilities: {0: 'Juice Boost'},
		baseSpecies: 'Tropius',
	},
  'Typhlosion-Mega': {		
		types: ['Fire', 'Rock'],
		bs: {hp: 78, at: 109, df: 114, sa: 134, sd: 104, sp: 95},
		weightkg: 149.0,
		abilities: {0: 'Heated Charge'},
		baseSpecies: 'Typhlosion',
	},
  'Victini-Mega': {		
		types: ['Fire', 'Fairy'],
		bs: {hp: 100, at: 130, df: 105, sa: 145, sd: 110, sp: 110},
		weightkg: 4.7,
		abilities: {0: 'Victory Star'},
		baseSpecies: 'Victini',
	},
